...
%%
% processing py file:
% trim spaces-->read into MATLAB-->remove def row-->write into connection
%.py
% read INP into MATLAB-->modify parameters-->write into INP file-->run
% connection.py
%%
% define filename
...
title('Node 2, displacements in y, total time=10s, deltaT=0.001s, E=5, reduce basis size=6, sine force')
