...
pm.comb=sparse(3, domainLength.I1*domainLength.I2);
...
% =========================================================================
toc
[err_max, err_max_loc]=max(err_store_log(:));
%}
...
while abs(err_max)<err_bd
    ...
    f_amp_free_R=Phi.iter_free'*f_amp_free;
    tic
    parfor i_iter=1:size(pm.comb, 1)
        ...
        [U_iter_R, V_iter_R, A_iter_R, U_iter, V_iter, A_iter, t_iter, time_step_NO_iter]=NewmarkBetaReducedMethod...
            (Phi.iter_free, M_iter_R, C_iter_R, K_iter_R, f_amp_free_R, acce, deltaT, MaxT, U0_iter_R, V0_iter_R, A0_iter_R);
