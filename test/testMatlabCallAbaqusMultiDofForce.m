clear; clc;
% this script tests applying force on multi-dofs.
...
inpNameUnmo = 'l9h2SingleInc_forceMultiDof';
...
fceVal(fceNode(1, :) * 2, 1:length(fce1)) = ...
    fceVal(fceNode(1, :) * 2, 1:length(fce1)) - fce1;
fceVal(fceNode(1, :) * 2 - 1, 1:length(fce1)) = ...
    fceVal(fceNode(1, :) * 2 - 1, 1:length(fce1)) - fce1;
fceVal(fceNode(2, :) * 2, 1:length(fce2)) = ...
    fceVal(fceNode(2, :) * 2, 1:length(fce2)) - fce2;
fceVal(fceNode(3, :) * 2, 1:length(fce3)) = ...
    fceVal(fceNode(3, :) * 2, 1:length(fce3)) - fce3;
