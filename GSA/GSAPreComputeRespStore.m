function [resp_store_init_local, resp_store_step_local] = GSAPreComputeRespStore...
...
%% For EACH RB, compute exact solution at interpolation points, store them (size=(no.pre*no.dof)), 
