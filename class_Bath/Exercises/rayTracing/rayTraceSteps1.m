function rayTraceSteps1(DIM,N)
% DIM = dimension of the scene as DIM x DIM pixels (input)
% N = number of spheres (input)
%
% Example: rayTraceSteps1(256,20) 
% Example: rayTraceSteps1(512,20) 
...
for x = 1:DIM
    %% TODO get rid of functional workspace by using nested kernel function
