...
errProMax = errProposedNouiTujN35.store.max.verify;
errProMaxRef = errProposedNouiTujN30InitRef.store.max.verify;
...
errPmLocPro = pmSpacePro(errProposedNouiTujN35.store.loc.verify(:, 1));
errPmLocProRef = pmSpacePro(errProposedNouiTujN30InitRef.store.loc.verify(:, 1));
