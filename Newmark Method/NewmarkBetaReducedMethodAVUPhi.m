function [U_r, V_r, A_r, U, V, A, t, time_step_NO] = NewmarkBetaReducedMethodAVUPhi...
    (Phi_a, Phi_v, Phi_u, M_r, C_r, K_r, F_r, acce, dT, maxT, U0, V0)
% 
% clear variables; clc;
% 
% Phi=eye(2);
...
for i_nm = 1:length(t)-1
    ...
    dFhat = F_r(:, i_nm+1)+M_r*(a0*U_r(:, i_nm)+a2*V_r(:, i_nm)+a3*A_r(:, i_nm))+...
