classdef beam < handle
    ...
    methods
        ...
        %%
        function obj = ...
                resptoErrPreCompAllTimeMatrix(obj, respSVDswitch, rvSVDswitch)
            ...
            for iPre = 1:nPre
                ...
                if respSVDswitch == 0
                    ...
                    elseif obj.indicator.enrich == 0 && ...
                            obj.indicator.refine == 1
                        % if refine, force responses are also refined, thus
        ...
        function obj = refiCond(obj, type)
            ...
            switch type
                ...
                case 'maxSurf'
                    ...
                    obj.refinement.condition = max(obj.err.store.surf.diff);
            end
        end
        %%
