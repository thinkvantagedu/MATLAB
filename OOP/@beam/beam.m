classdef beam < handle
    ...
    methods
        ...
        function obj = beam(masFile, damFile, stiFile, ...
                locStart, locEnd, INPname, domLeng1, domLeng2, domLengs, ...
            ...
            obj.domLeng.I1 = domLeng1;
            obj.domLeng.I2 = domLeng2;
        ...
        function obj = generatePmSpaceMultiDim(obj)
            ...
            obj.domLeng.i = obj.domLeng.s * ones(1, obj.no.inc);
            
            for i = 1:obj.no.inc
                
                pmValIspace(i) = {logspace(obj.domBond.I1.L, ...
                    obj.domBond.I1.R, obj.domLeng.I1)};
        ...
        function obj = pmTrial(obj)
            ...
            if obj.no.inc == 1
                ...
                pmCombIdx = obj.pmVal.comb.trial;
            else
                pmCombIdx = (obj.pmVal.comb.trial(2) - 1) * ...
                    obj.domLeng.I1 + obj.pmVal.comb.trial(1);
            end
...
%             obj.pmVal.I2.trial = pmCombRow(:, 4);
        ...
        function obj = errPrepareRemain(obj)
            ...
            obj.err.store.allBlk.hhat = cell(obj.domLeng.I1, obj.domLeng.I2);
            obj.err.store.allBlk.hat = cell(obj.domLeng.I1, obj.domLeng.I2);
        end
        %%
        ...
        function obj = errPrepareSetZero(obj)
            ...
            obj.err.store.surf.errwRb = zeros(obj.domLeng.I1, obj.domLeng.I2);
            obj.err.store.surf.diff = zeros(obj.domLeng.I1, obj.domLeng.I2);
            obj.err.store.svdSingle = cell(obj.domLeng.I1 * obj.domLeng.I2, 1);
            
        end
        %%
        function obj = errPrepareSetZeroOriginal(obj)
            if obj.no.inc == 1
                obj.err.store.surf = zeros(obj.domLeng.i, 1);
            else
                obj.err.store.surf = zeros(obj.domLeng.i);
            end
        end
        %%
        ...
        %%
        function obj = conditionalItplProdRvPmSVD(obj, iIter)
            ...
            if obj.no.block.hat == 1
                ...
                obj.inpolyItpl('hhat');
                obj.inpolyItpl('hat');
                obj.rvPmErrProdSum('hhat', 1);
                obj.rvPmErrProdSum('hat', 1);
                obj.err.store.svdSingle(iIter) = {obj.err.store.preSqrt};
        ...
        function obj = extractErrorInfo(obj, type, randomSwitch)
            ...
            switch type
                ...
                case 'original'
                    ...
                    if randomSwitch == 1
                        if obj.countGreedy == 1
                            obj.err.max.loc = pmValRow(:, 1:2);
                        elseif obj.countGreedy > 1
                            obj.err.max.loc = ...
                                [randi([1 obj.domLeng.I1], 1), ...
                                randi([1 obj.domLeng.I1], 1)];
                        end
                    else
