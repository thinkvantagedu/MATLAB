classdef canbeam < beam
    ...
    methods
        ...
        function obj = canbeam(masFile, damFile, stiFile, ...
                locStart, locEnd, INPname, domLength1, domLength2, ...
                domLengths, bondL1, bondR1, bondL2, bondR2, trial, noIncl, ...
                tMax, tStep, mid1, mid2, errLowBond, errMaxVal, errRbCtrl, ...
            ...
            obj = obj@beam(masFile, damFile, stiFile, locStart, ...
                locEnd, INPname, domLength1, domLength2, ...
                domLengths, bondL1, bondR1, bondL2, bondR2, trial, noIncl, ...
                tMax, tStep, mid1, mid2, errLowBond, errMaxVal, errRbCtrl, ...
                errRbCtrlThres, errRbCtrlTNo, cntInit, refiThres, ...
